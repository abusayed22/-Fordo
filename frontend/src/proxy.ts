...
export async function proxy(request: NextRequest) {
  try {
    ...
    const routerOwner = getOwnerRole(pathname);
    ...
    //Rule - Enforcing user to stay in reset password or verify email page if their needPasswordChange or isEmailVerified flas are not satisfied respectively
