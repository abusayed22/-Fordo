            ...
            >
              <div className="space-y-3">
                <div className="flex items-start justify-between gap-2.5">
                  ...
                  <span
                    className={`text-[10px] font-semibold px-2 py-0.5 rounded-md border shrink-0 ${brand.status === "Active"
              ...
              {hasManagerAccess && (
                <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                  <button
                    ...
                    className={`text-[11px] font-semibold px-2 py-1 rounded transition-colors cursor-pointer ${brand.status === "Active"
